...
public class TestMarket {
	...
	public void test() {
		...
		ClientSideRMIConnectorInt clientSideRMIConnectorInt1 = new SocketConnector(new Socket());
		Player player1 = new Player(clientSideRMIConnectorInt1,1);
		ClientSideRMIConnectorInt clientSideRMIConnectorInt2 = new SocketConnector(new Socket());
		Player player2 = new Player(clientSideRMIConnectorInt2,2);
		ClientSideRMIConnectorInt clientSideRMIConnectorInt3 = new SocketConnector(new Socket());
		Player player3 = new Player(clientSideRMIConnectorInt3,3);
		...
		ClientSideRMIConnectorInt clientSideRMIConnectorInt4 = new SocketConnector(new Socket());
		Player player4 = new Player(clientSideRMIConnectorInt1,4);
		player4.addCoins(3);
		try {
